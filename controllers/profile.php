...
if (!isset($_SESSION['user_id'])) {
    ...
    if (!empty($_POST['last_update'])) {
        ...
        $dataUser = BodyOlimpusDataUser::updateDataUserProfile($id_user,$first_name,$last_name,$email,$gender,$phone_number,$exercise_space,$actual_weight,$last_update);
        if ($dataUser == "Datos de usuario actualizado") {
            $nameView = 'bo_profile';
            $message = $dataUser;
